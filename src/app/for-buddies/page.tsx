        ...
        <>
            ...
            <main className="">
                    ...
                    <div className="container mx-auto flex px-20 py-10 items-center justify-center flex-col">
                        <div className="text-center lg:w-2/3 w-full ">
                            ...
                            <div className="flex justify-center">
                                <div className='priceSwitcher shadow-card relative inline-flex cursor-pointer select-none items-center justify-center rounded-md p-1'>
                                    <span onClick={() => handlePriceChange('m')} className={`flex items-center space-x-[6px] rounded py-2 px-[18px] text-sm font-medium ${!isChecked ? 'text-primary bg-[#f4f7ff]' : 'text-body-color'}`}>
                                        Billed Monthly
                                    </span>
                                    <span onClick={() => handlePriceChange('y')} className={`flex items-center space-x-[6px] rounded py-2 px-[18px] text-sm font-medium ${isChecked ? 'text-primary bg-[#f4f7ff]' : 'text-body-color'}`}>
                                        Billed Annually
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div className="plan-details bg-fi-white flex flex-row sm:w-screen lg:w-1/2 w-1/2 my-10 px-28 py-20 text-lg justify-between rounded-lg ">
                ...
                <section className=" text-gray-100 px-8 icon pb-10">
                    ...
                    <div
                        className="max-w-screen-xl mt-14 mb-20 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg">
