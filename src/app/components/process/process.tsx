...
export const Process = () => {
    return (
        <section className=" body-font text-center mx-20">
            <h1 className="title text text-3xl">How it works?</h1>
            <div className="flex">
                <div className="container px-5 py-12 mx-auto flex flex-wrap text-left">
                    <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            <div className="flex-shrink-0 w-24 h-24 bg-indigo-100 text-green-700 rounded-full inline-flex items-center justify-center">
                            ...
                            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                ...
                                <p className="leading-relaxed">Sign up. Fill your details and start your path of healing.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="sm:hidden lg:block text-center">
                    <Image
                        src={heroImage}
                        className="m-0 self-center ml-20 mt-20 mb-10"
                        alt=""
                    />
                    <p className="">
